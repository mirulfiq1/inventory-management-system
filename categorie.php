...
function mampus(id){
    ...
    if(sts) {
        document.location.href="delete_categorie.php?id="+id;
    } else {
        return false;
    }
}
                ...
                <tr>
                    ...
                    <td class="text-center">
                      <div class="btn-group">
                        ...
                        <a href="javascript:void()" onclick="mampus(<?php echo (int)$cat['id'];?>)" class="btn btn-xs btn-danger" data-toggle="tooltip" title="Remove">
